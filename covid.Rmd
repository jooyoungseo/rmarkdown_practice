...
Cases have been identified in a growing number of other locations internationally, including the United States.
...
# Need to download "coronavirus" package from GitHub
if (!require(remotes)) {
